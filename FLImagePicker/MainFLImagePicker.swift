...
internal class MainFLImagePicker: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UIGestureRecognizerDelegate {
    ...
    /* initialize*/
    init(){
        super.init(nibName: "MainFLImagePicker", bundle: Bundle.init(for: MainFLImagePicker.self))
    }
    ...
    /* ui*/
    func uiInit(){
        mainCV.register(UINib(nibName: "MainFLImagePickerCell", bundle: Bundle(for: MainFLImagePickerCell.self)), forCellWithReuseIdentifier: "FLImgCell")
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imgAsset = asset
        cell.setSelected(isSelect: mainCV.indexPathsForSelectedItems?.contains(indexPath) ?? false)
        return cell
    }
}
